...
tianwendongApp.factory('LanguageService', function ($http, $translate, LANGUAGES) {
        return {
...
tianwendongApp.factory('Register', function ($resource) {
        return $resource('app/rest/register', {}, {
        });
    });

tianwendongApp.factory('Activate', function ($resource) {
        return $resource('app/rest/activate', {}, {
            'get': { method: 'GET', params: {}, isArray: false}
        });
    });

tianwendongApp.factory('Account', function ($resource) {
        return $resource('app/rest/account', {}, {
        });
    });

tianwendongApp.factory('Password', function ($resource) {
        return $resource('app/rest/account/change_password', {}, {
        });
    });

tianwendongApp.factory('Sessions', function ($resource) {
        return $resource('app/rest/account/sessions/:series', {}, {
            'get': { method: 'GET', isArray: true}
        });
    });

tianwendongApp.factory('Lucky', function ($resource) {
        return $resource('app/rest/items/lucky', {}, {
            'get': { method: 'GET' }
        });
    });
...
tianwendongApp.factory('LogsService', function ($resource) {
...
tianwendongApp.factory('AuditsService', function ($http) {
        return {
            findAll: function() {
...
tianwendongApp.factory('Session', function () {
...
tianwendongApp.factory('AuthenticationSharedService', function ($rootScope, $http, authService, Session, Account) {
        return {
