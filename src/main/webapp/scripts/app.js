...
var tianwendongApp = angular.module('tianwendongApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'tianwendongAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
